...
public class TrajectorySpacialRangeQueryTopology {
    ...
    public static void main(String[] args) throws Exception {
        ...
        config.put("k", k);
        if("geolife".equals(dataset)){
            config.put("minLat", "1.044024");
            config.put("maxLat", "63.0141583");
            config.put("minLng", "-179.9695933");
            config.put("maxLng", "179.9969416");
        }
        else if("tdrive".equals(dataset)){
            config.put("minLat", "0.0");
            config.put("maxLat", "65.20465");
