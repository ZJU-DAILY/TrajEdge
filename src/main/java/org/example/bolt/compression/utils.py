...
def numDirection(roadnetwork, vertice_dict, stPath_st, stPath_end, middle, end):
    ...
    for node in all_nodes:
        ...
        angle = (360 + CalAngle(to_vector(stPathst_pos, stPathend_pos), to_vector(middle_pos, node_pos))) % 360
...
def network_data():
    base = 'C:\\Users\\HeAlec\\Desktop\\tdrive\\'
...
def get_candidates(row, nx_edge):
...
def transmission_probability(roadnetwork, edge_dict, vertice_dict, traj):
    v_list = [[]]
